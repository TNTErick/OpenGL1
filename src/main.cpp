...
{
    // wxWidgets will handle all pointers that are descendants of wxObject so we don't worry about destruction and freeing memories.
public:
    MyApp() {}
...
// 　Initialise the canvas with wxGLContext in it.
